...
@OnlyIn(Dist.CLIENT)
public class SmallFlameParticle extends SpriteTexturedParticle {
   public SmallFlameParticle(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeedIn, double zSpeedIn) {
   ...
   public float getScale(float partialticks) {
      ...
      return this.particleScale * (1.0F - f * f * 0.3F);
   }
