...
public class ModBlocks {
		...
		public static final RegistryObject<Block> TESTBLOCK = BLOCKS.register("testblock", () -> new Block(Block.Properties.create(Material.ROCK).harvestTool(ToolType.PICKAXE).harvestLevel(HARVEST_LEVEL_IRON).hardnessAndResistance(5.0F, 15.0F).sound(SoundType.STONE)));
