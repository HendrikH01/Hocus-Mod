package com.xX_deadbush_Xx.witchcraftmod.client.renderers.entities;
...
public class LightningBallRenderer extends EntityRenderer<LightningBallEntity> {
	private static final ResourceLocation TEXTURE = new ResourceLocation(WitchcraftMod.MOD_ID, "textures/entity/lightning_ball.png");
