...
import com.xX_deadbush_Xx.witchcraftmod.client.effect.particles.WaveShimmerParticle;
...
public class ParticleDebugger extends Item {
	...
	public ActionResultType onItemUse(ItemUseContext context) {
		...
		if(world.isRemote) {
			...
			world.addParticle(WaveShimmerParticle.getData(true, Color.MAGENTA.getRGB(), 1), pos.getX() + 0.5, pos.getY() + 0.5, pos.getZ() + 0.5,  pos.getX() + 15, pos.getY() + 0, pos.getZ() + 10);
