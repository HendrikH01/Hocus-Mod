package com.xX_deadbush_Xx.witchcraftmod.common.world.data.wsd;
...
public class RecipeInputWSD extends WorldSavedData {
    private static final String NAME = WitchcraftMod.MOD_ID + "_recipe_inputs";
    private World world;
    ...
    public static RecipeInputWSD read(ServerWorld world) {
        ...
        RecipeInputWSD instance = (RecipeInputWSD) storage.getOrCreate(() -> new RecipeInputWSD(world), WitchcraftMod.MOD_ID);
