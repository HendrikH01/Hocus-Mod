...
public class RenderHelper {
	...
	public static IRenderTypeBuffer.Impl spellbuffers = IRenderTypeBuffer.getImpl(
			Util.make(new HashMap<>(), map -> {
				map.put(ModRenderTypes.MANAWAVE, new BufferBuilder(ModRenderTypes.MANAWAVE.getBufferSize()));
				map.put(ModRenderTypes.LIGHTNING_SPELL, new BufferBuilder(ModRenderTypes.LIGHTNING_SPELL.getBufferSize()));
