...
public class AutoToolTableResultSlot extends SlotItemHandler {
	private AutoToolTableContainer container;
	private PlayerEntity player;
	private int amountCrafted;

	public AutoToolTableResultSlot(IItemHandlerModifiable itemHandler, PlayerEntity player, AutoToolTableContainer container, int index, int xPosition, int yPosition) {
