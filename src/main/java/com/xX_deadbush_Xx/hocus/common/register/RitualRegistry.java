...
import com.xX_deadbush_Xx.hocus.common.rituals.large.LargeFusionRitual;
import com.xX_deadbush_Xx.hocus.common.rituals.medium.BloodInfusionRitual;
import com.xX_deadbush_Xx.hocus.common.rituals.medium.MediumFusionRitual;
import com.xX_deadbush_Xx.hocus.common.rituals.medium.WeatherControllRitual;
import com.xX_deadbush_Xx.hocus.common.rituals.small.SmallAnimalGrowthRitual;
import com.xX_deadbush_Xx.hocus.common.rituals.small.SmallFusionRitual;
import com.xX_deadbush_Xx.hocus.common.rituals.small.SmallGrowthRitual;
...
public class RitualRegistry {
	...
	private void register(String name, RitualConfig config, IFactory factory) {
		register(new ResourceLocation(Hocus.MOD_ID, name), config, factory);
	}
