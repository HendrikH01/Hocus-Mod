...
public enum ModArmorMaterials implements IArmorMaterial {
	...
	SILVER(Hocus.MOD_ID + ":silver", 19, new int[]{2, 6, 6, 3}, 16, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.7F, ()-> {
		return Ingredient.fromItems(ModItems.SILVER_INGOT.get());
	}),
	
	MAGIC_LEATHER(Hocus.MOD_ID + ":magic_leather", 9, new int[]{2, 3, 4, 2}, 26, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 0.0F, ()-> {
		return Ingredient.fromItems(Items.LEATHER);
	}),
	MANA_GOGGLES(Hocus.MOD_ID + ":mana_goggles", 5, new int[]{0, 0, 0, 2}, 6, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 0.0F, null);
