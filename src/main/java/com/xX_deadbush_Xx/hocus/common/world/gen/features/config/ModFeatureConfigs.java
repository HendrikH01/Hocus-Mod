...
public class ModFeatureConfigs {
	...
	private static final Set<Block> ENCHANTED_FOREST_PLACEMENT_WHITELIST = ImmutableSet.of(Blocks.GRASS);
	...
	public static final TreeFeatureConfig DREADWOOD_TREE = new TreeFeatureConfig.Builder(
			...
			new SimpleBlockStateProvider(ModBlocks.DREADWOOD_LEAVES.get().getDefaultState()), new DreadwoodTreeFoliagePlacer(3, 1))
			.baseHeight(6)
			.heightRandA(1)
			.heightRandB(1)
			.trunkHeight(5)
			.trunkHeightRandom(2)
			.decorators(ImmutableList.of(new BeehiveTreeDecorator(0.05F), new TreeIvyDecorator(), new CobwebDecorator()))
			.ignoreVines()
	...
	public static final BlockClusterFeatureConfig ADONIS_FEATURE = new BlockClusterFeatureConfig.Builder(
			...
			.tries(32)
			.whitelist(ENCHANTED_FOREST_PLACEMENT_WHITELIST)
			.func_227317_b_()
			.build();
	...
	public static final BlockClusterFeatureConfig GRASS_CONFIG_WHITELISTED = new BlockClusterFeatureConfig.Builder(
			new SimpleBlockStateProvider(Blocks.GRASS.getDefaultState()), new SimpleBlockPlacer()).tries(32).whitelist(ENCHANTED_FOREST_PLACEMENT_WHITELIST).build();
	
	public static final BlockClusterFeatureConfig TALL_GRASS_CONFIG_WHITELISTED = new BlockClusterFeatureConfig.Builder(
			new SimpleBlockStateProvider(Blocks.TALL_GRASS.getDefaultState()), new SimpleBlockPlacer()).tries(32).whitelist(ENCHANTED_FOREST_PLACEMENT_WHITELIST).build();
